...
const routes: Routes = [
...

	{
		...
		children: [
			...
			{
				path: 'createorder',
				loadChildren: () => import('app/views/pages/fashion-tubs/pages/orders/orders/orders.module').then(m => m.OrdersModule),
			},
			{
				path: 'orderout',
				loadChildren: () => import('app/views/pages/fashion-tubs/pages/order-list/order-list.module').then(m => m.OrderListModule),
			},
			{
				path: 'mail',
